 ...
 * @author mconlago
 */
public class ReporteServletXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        byte[] reporteInforme = (byte[]) request.getSession().getAttribute("reporteInformeXls");
        try {
            if (reporteInforme != null) {
                if (reporteInforme.length > 778) {
